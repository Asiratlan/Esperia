...
public class TileEntityHRPSignRenderer extends TileEntitySpecialRenderer<TileEntityHRPSignEsperia> {

	private static final ResourceLocation SIGN_TEXTURE = new ResourceLocation("esperia",
			"textures/blocks/hrpsign-b.png");

	/** The ModelSign instance for use in this renderer */
	private final ModelSign model = new ModelSign();

	@Override
	public void render(TileEntityHRPSignEsperia te, double x, double y, double z, float partialTicks, int destroyStage, float alpha){
		Block block = te.getBlockType();
		GlStateManager.pushMatrix();
		float f = 0.6666667F;

		if (block == net.esperia.BlocksRegistry.hrp_standing_sign || block == net.esperia.BlocksRegistry.stone_standing_sign) {
