...
public class TileEntityWallNoteRenderer extends TileEntitySpecialRenderer<TileEntityWallNote> {
  private static final ResourceLocation TEXTURE = new ResourceLocation(Esperia.MOD_ID, "textures/entity/wall_note/wall_note.png");
  ...
  @Override
  public void render(TileEntityWallNote te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
