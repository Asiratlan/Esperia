...
public class GuiChessBoard extends GuiContainer {
    ...
    private static final ResourceLocation CHESS = new ResourceLocation("esperia", "textures/gui/container/chess.png");
    ...
    public GuiChessBoard(TileEntityChessBoard tileEntity, InventoryPlayer inventory) {
        super(new ContainerChessBoard(inventory, tileEntity));
        this.tileChess = tileEntity;
