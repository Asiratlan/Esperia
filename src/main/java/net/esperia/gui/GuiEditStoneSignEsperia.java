...
public class GuiEditStoneSignEsperia extends GuiScreen {

    /**
     * Reference to the sign object.
     */
    private final TileEntityStoneSignEsperia tileSign;
    /**
    ...
    public GuiEditStoneSignEsperia(
            TileEntityStoneSignEsperia teSign/* , InventoryPlayer playerInv */) {
        // super(new ContainerHRPSignEsperia(teSign, playerInv));
    ...
    public void initGui() {
        ...
        this.doneBtn = this.addButton(
                new GuiButton(0, this.width / 2 - 100, this.height / 4 + 120, I18n.format("gui.done", new Object[0])));
 ...
 /*
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRenderer, I18n.format("sign.edit", new Object[0]), this.width / 2, 40,
                16777215);
