...
public class GuiMainMenu extends GuiScreen {
     ...
     * screen says <a
     * href="https://minecraft.gamepedia.com/Menu_screen#Minceraft">Minceraft</a>
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
        ...
        this.buttonList.add(new GuiButton(2, this.width / 2 - 100, p_73969_1_, I18n.format("menu.esperia.wakeup")));
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (button.id == 2) {
            connectToServer("roleplay.esperia-rp.net:45678");
        }
