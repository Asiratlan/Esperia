...
public class GuiFurniture extends GuiContainer {
    ...
    public TileEntityFurniture tilentity;

    public GuiFurniture(TileEntityFurniture tile, InventoryPlayer inventorySlotsIn) {
        super(new ContainerFurniture(inventorySlotsIn, tile));
        tilentity = tile;
    }
