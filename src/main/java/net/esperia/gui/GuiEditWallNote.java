...
public class GuiEditWallNote extends GuiScreen {
    ...
    public void onGuiClosed() {
        ...
        // @f0
        ITextComponent[] lines = Arrays.asList(this.tileNote.getText()).stream().map(text -> text != null ? text/*.getFormattedText()*/ : null)
                .toArray(ITextComponent[]::new);
        // @f1
        Esperia.network.sendToServer(new UpdateWallNoteMessage(this.tileNote.getPos(), lines));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(this.fontRenderer, "Editer la note", this.width / 2, 30, 0xffffff);
        ...
        TileEntityRendererDispatcher.instance.render(this.tileNote, -0.5, -0.75, -0.5, 0);
