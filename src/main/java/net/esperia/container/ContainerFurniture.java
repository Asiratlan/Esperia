...
public class ContainerFurniture extends Container {

    private TileEntityFurniture tileEntity;
    private IInventory inventory;

    public ContainerFurniture(IInventory inventory, TileEntityFurniture tileEntity) {
