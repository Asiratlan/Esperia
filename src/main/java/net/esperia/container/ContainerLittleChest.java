...
public class ContainerLittleChest extends Container {

    private TileEntityLittleChest tileEntity;

    public ContainerLittleChest(IInventory inventory, TileEntityLittleChest tileEntity) {
