...
public class ContainerPlacard extends Container {

	private TileEntityPlacard tileEntity;
	private IInventory inventory;
	private int numRows;

	public ContainerPlacard(IInventory inventory, TileEntityPlacard tileEntity) {
