...
public class InventaireDiceGlass extends InventaireItemContainer {

    public InventaireDiceGlass(ItemStack container) {
        super(container, 6);
    }
	...
	public ITextComponent getDisplayName() {
		return new TextComponentString("esperia.container.diceglass");
	}
