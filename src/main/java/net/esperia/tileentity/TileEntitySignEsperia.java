...
public class TileEntitySignEsperia extends TileEntitySign {
    ...
    public void readFromNBT(NBTTagCompound compound)
    {
        ...
        ICommandSender icommandsender = new ICommandSender()
        {
            ...
            {
                return TileEntitySignEsperia.this.pos;
            }
            /**
            ...
            {
                return new Vec3d((double)TileEntitySignEsperia.this.pos.getX() + 0.5D, (double)TileEntitySignEsperia.this.pos.getY() + 0.5D, (double)TileEntitySignEsperia.this.pos.getZ() + 0.5D);
            }
            /**
            ...
            {
                return TileEntitySignEsperia.this.world;
            }
            /**
            ...
            {
                return TileEntitySignEsperia.this.world.getMinecraftServer();
            }
        };
    ...
    public boolean executeCommand(final EntityPlayer playerIn)
    {
        ICommandSender icommandsender = new ICommandSender()
        {
            ...
            public void setCommandStat(CommandResultStats.Type type, int amount)
            {
                if (TileEntitySignEsperia.this.world != null && !TileEntitySignEsperia.this.world.isRemote)
                {
                	TileEntitySignEsperia.this.stats.setCommandStatForSender(TileEntitySignEsperia.this.world.getMinecraftServer(), this, type, amount);
                }
            }
            /**
             * Get the Minecraft server instance
