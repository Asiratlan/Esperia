...
public class TileEntityHRPSignEsperia extends TileEntitySign {
    ...
    public void readFromNBT(NBTTagCompound compound)
    {
        ...
        ICommandSender icommandsender = new ICommandSender()
        {
            ...
            {
                return TileEntityHRPSignEsperia.this.pos;
            }
            /**
            ...
            {
                return new Vec3d((double)TileEntityHRPSignEsperia.this.pos.getX() + 0.5D, (double)TileEntityHRPSignEsperia.this.pos.getY() + 0.5D, (double)TileEntityHRPSignEsperia.this.pos.getZ() + 0.5D);
            }
            /**
            ...
            {
                return TileEntityHRPSignEsperia.this.world;
            }
            /**
            ...
            {
                return TileEntityHRPSignEsperia.this.world.getMinecraftServer();
            }
        };
    ...
    public boolean executeCommand(final EntityPlayer playerIn)
    {
        ICommandSender icommandsender = new ICommandSender()
        {
            ...
            public void setCommandStat(CommandResultStats.Type type, int amount)
            {
                if (TileEntityHRPSignEsperia.this.world != null && !TileEntityHRPSignEsperia.this.world.isRemote)
                {
                	TileEntityHRPSignEsperia.this.stats.setCommandStatForSender(TileEntityHRPSignEsperia.this.world.getMinecraftServer(), this, type, amount);
                }
            }
            /**
             * Get the Minecraft server instance
