...
public class TileEntityPlacard extends TileEntityLockableLoot implements IInventory {
	...
	public String getName() {
		...
		return this.hasCustomName() ? this.customName : "container.cupboard.name";
	}
	...
	public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
		...
		return new ContainerPlacard(playerInventory, this);
	}

	@Override
	public String getGuiID() {
		// TODO Auto-generated method stub
		return "esperia:placard";
	}
