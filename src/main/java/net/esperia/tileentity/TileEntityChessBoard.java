...
public class TileEntityChessBoard extends TileEntityLockableLoot implements IInventory {

	private NonNullList<ItemStack> placardContents = NonNullList.<ItemStack>withSize(64, ItemStack.EMPTY);
	private String customName;

	@Override
	public String getName() {
		// TODO Auto-generated method stub
		return this.hasCustomName() ? this.customName : "Jeu d'Échec";
	}
	...
	public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
		...
		return new ContainerChessBoard(playerInventory, this);
	}

	@Override
	public String getGuiID() {
		// TODO Auto-generated method stub
		return "esperia:chess_board";
	}
