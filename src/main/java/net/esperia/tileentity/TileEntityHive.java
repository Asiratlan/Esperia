...
import net.esperia.renders.MobHiveLogic;
...
public class TileEntityHive extends TileEntity implements ITickable{
	...
	private final MobHiveLogic spawnerLogic = new MobHiveLogic()
    {
        public void broadcastEvent(int id)
        {
            TileEntityHive.this.world.addBlockEvent(TileEntityHive.this.pos, Blocks.MOB_SPAWNER, id, 0);
        }
        public World getSpawnerWorld()
        {
            return TileEntityHive.this.world;
        }
        public BlockPos getSpawnerPosition()
        {
            return TileEntityHive.this.pos;
        }
        public void setNextSpawnData(WeightedSpawnerEntity p_184993_1_)
        {
            ...
            if (this.getSpawnerWorld() != null)
            {
                ...
                this.getSpawnerWorld().notifyBlockUpdate(TileEntityHive.this.pos, iblockstate, iblockstate, 4);
            }
        }
    };
    ...
    public MobHiveLogic getSpawnerBaseLogic()
    {
