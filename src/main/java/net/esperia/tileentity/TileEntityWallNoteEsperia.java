...
public class TileEntityWallNoteEsperia extends TileEntity {
	 ...
	 * to be visible.
	 */
	private SignColor color = SignColor.WHITE;
	 ...
	 * state, EntityPlayer player, EnumFacing side, float hitX, float hitY,
	 * float hitZ) { if (!world.isRemote) {
	 * //player.openGui(Esperia.instance(), GuiHandler.GUI_HRP_SIGN, world,
	 * pos.getX(), pos.getY(), pos.getZ()); } return true; }
	 */
	@Override
	...
	public void readFromNBT(NBTTagCompound compound) {
		...
		ICommandSender icommandsender = new ICommandSender() {
			...
			public BlockPos getPosition() {
				return TileEntityWallNoteEsperia.this.pos;
			}
			...
			public Vec3d getPositionVector() {
				return new Vec3d((double) TileEntityWallNoteEsperia.this.pos.getX() + 0.5D,
						(double) TileEntityWallNoteEsperia.this.pos.getY() + 0.5D,
						(double) TileEntityWallNoteEsperia.this.pos.getZ() + 0.5D);
			}
			...
			public World getEntityWorld() {
				return TileEntityWallNoteEsperia.this.world;
			}
			...
			public MinecraftServer getServer() {
				return TileEntityWallNoteEsperia.this.world.getMinecraftServer();
			}
		};
	...
	public boolean executeCommand(final EntityPlayer playerIn) {
		ICommandSender icommandsender = new ICommandSender() {
			...
			public void setCommandStat(CommandResultStats.Type type, int amount) {
				if (TileEntityWallNoteEsperia.this.world != null && !TileEntityWallNoteEsperia.this.world.isRemote) {
					TileEntityWallNoteEsperia.this.stats.setCommandStatForSender(
							TileEntityWallNoteEsperia.this.world.getMinecraftServer(), this, type, amount);
				}
			}
	...
	public enum SignColor {
		BLACK("000000"), DARK_BLUE("0000BF"), DARK_GREEN("00BF00"), DARK_CYAN("00BFBF"), DARK_RED("BF0000"), PURPLE(
				"BF00BF"), GOLD("BFBF00"), GREY("BFBFBF"), DARK_GREY("404040"), BLUE("4040FF"), LIGHT_GREEN(
						"49FF40"), CYAN("40FFFF"), RED("FF4040"), PINK("FF40FF"), YELLOW("FFFF40"), WHITE("FFFFFF");
