...
public class TileEntityCustomBedRenderer extends TileEntitySpecialRenderer<TileEntityCustomBed>
{
	private static final ResourceLocation TEXTURE = new ResourceLocation(Esperia.MOD_ID, "textures/entity/hay_bed/hay_bed.png");
    private ModelBed model = new ModelBed();
    private int version;

    public TileEntityCustomBedRenderer()
    {
        this.version = this.model.getModelVersion();
    }

    public void render(TileEntityCustomBed te, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
