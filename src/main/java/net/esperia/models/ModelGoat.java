...
public class ModelGoat extends ModelBase
{
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        if (this.typeInt > 1)
        {
            if ((double)this.edad > 0.7D)
            {
                this.RHorn1.render(f5);
                this.LHorn1.render(f5);
            }

            if ((double)this.edad > 0.8D)
            {
                this.RHorn2.render(f5);
                this.LHorn2.render(f5);
            }
        ...
        if (this.typeInt > 4)
        {
            ...
            if ((double)this.edad > 0.85D)
            {
                this.RHorn4.render(f5);
                this.LHorn4.render(f5);
            }

            if ((double)this.edad > 0.9D)
            {
                this.RHorn5.render(f5);
                this.LHorn5.render(f5);
            }
        ...
        {
            GL11.glTranslatef((float)this.eatMov / 100.0F, 0.0F, 0.0F);
        }

        if (this.typeInt > 4 && (double)this.edad > 0.9D)
        {
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        this.Tail.rotateAngleX = (float)this.tailMov / (180F / (float)Math.PI);
        ...
        if (this.attacking != 0)
        {
            this.Head.rotateAngleX = (float)this.attacking / (180F / (float)Math.PI);
            this.Neck.rotateAngleX = (1.33F * (float)this.attacking - 70.0F) / (180F / (float)Math.PI);

            if (this.legMov != 0)
            {
                this.Leg1.rotateAngleX = (float)this.legMov / (180F / (float)Math.PI);
            }
        }
        ...
        {
            this.LEar.rotateAngleX = baseAngle + (float)this.earMov / (180F / (float)Math.PI);
            this.REar.rotateAngleX = baseAngle + (float)this.earMov / (180F / (float)Math.PI);
        }
