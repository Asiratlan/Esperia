...
public class BlockFlowerPot extends BlockContainer {
    ...
    public BlockFlowerPot()
    {
        ...
        setRegistryName(Esperia.MOD_ID, "flower_pot");
		setUnlocalizedName(Esperia.MOD_ID + ".flower_pot");
		setCreativeTab(CreativeTabs.DECORATIONS);
		net.minecraft.init.Items.FLOWER_POT.setCreativeTab(null); //disable vanilla flower pot
    }
    ...
    private boolean canBePotted(ItemStack stack)
    {
        ...
        if (block != Blocks.YELLOW_FLOWER && block != Blocks.RED_FLOWER && block != Blocks.CACTUS && block != Blocks.BROWN_MUSHROOM && block != Blocks.RED_MUSHROOM && block != Blocks.SAPLING && block != Blocks.DEADBUSH)
        {
            ...
            return block == Blocks.TALLGRASS && i == BlockTallGrass.EnumType.FERN.getMeta() || block instanceof BlockPlant || block instanceof BlockMushroom;
        }
        else
        {
            return true;
    ...
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        return new ItemStack(BlocksRegistry.flower_pot);
    }
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
    {
        ...
        if (tileentity instanceof TileEntityFlowerPot)
        {
            ...
            if (item instanceof ItemBlock)
            {
                ...
                if(block instanceof net.esperia.block.BlockPlant || block instanceof BlockMushroom){
                	if(block == BlocksRegistry.flower_blue_hydrangea)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.BLUE_HYDRANGEA;
                 	else if(block == BlocksRegistry.flower_bluebells)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.BLUEBELLS;
                 	else if(block == BlocksRegistry.flower_bromeliad)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.BROMELIAD;
                 	else if(block == BlocksRegistry.flower_daisy)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.DAISY;
                 	else if(block == BlocksRegistry.flower_dandelion)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.ESPDANDELION;
                 	else if(block == BlocksRegistry.flower_goldenrod)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.GOLDENROD;
                 	else if(block == BlocksRegistry.flower_iris)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.IRIS;
                 	else if(block == BlocksRegistry.flower_lavender)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.LAVENDER;
                 	else if(block == BlocksRegistry.flower_lily)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.LILY;
                 	else if(block == BlocksRegistry.flower_orange_cosmos)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.ORANGECOSMOS;
                 	else if(block == BlocksRegistry.flower_pink_daffodil)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.PINKDAFFODIL;
                	else if(block == BlocksRegistry.flower_pink_hibiscus)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.PINKHIBISCUS;
                	else if(block == BlocksRegistry.flower_swampflower)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.SWAMPFLOWER;
                	else if(block == BlocksRegistry.flower_swampviolets)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.SWAMPVIOLETS;
                	else if(block == BlocksRegistry.flower_violets)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.VIOLET;
                	else if(block == BlocksRegistry.flower_wildflower)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.WILDFLOWER;
                	else if(block == BlocksRegistry.mushroom_blue_milk_cap)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.BLUEMILKCAP;
                	else if(block == BlocksRegistry.mushroom_flat)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.FLAT;
                	else if(block == BlocksRegistry.mushroom_portobello)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.PORTOBELLO;
                   	else if(block == BlocksRegistry.mushroom_strange)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.STRANGE;
                   	else if(block == BlocksRegistry.mushroom_toadstool)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.TOADSTOOL;
                	else if(block == BlocksRegistry.plant_tea)
                		blockflowerpot$enumflowertype = BlockFlowerPot.EnumFlowerType.TEA;
                }
	...
	public void registerItemModel(Item itemBlock) {
		Esperia.proxy.addIgnoreToModel(BlocksRegistry.flower_pot, BlockFlowerPot.LEGACY_DATA);
    ...
    public static enum EnumFlowerType implements IStringSerializable
    {
        ...
        CACTUS("cactus"),
        VIOLET("violets"),
        BLUE_HYDRANGEA("blue_hydrangea"),
        BLUEBELLS("bluebells"),
        BROMELIAD("bromeliad"),
        DAISY("daisy"),
        ESPDANDELION("esp_dandelion"),
        GOLDENROD("goldenrod"),
        IRIS("iris"),
        LAVENDER("lavender"),
        LILY("lily"),
        ORANGECOSMOS("orange_cosmos"),
        PINKDAFFODIL("pink_daffodil"),
        PINKHIBISCUS("pink_hibiscus"),
        SWAMPFLOWER("swampflower"),
        SWAMPVIOLETS("swampviolets"),
        WILDFLOWER("wildflower"),
        BLUEMILKCAP("blue_milk_cap"),
        FLAT("flat"),
