...
public abstract class BlockStoneSlab_b extends BlockSlab implements MultipleItemObject, SpecialItemBlock {

	private static final PropertyEnum<Variants> VARIANT = PropertyEnum.create("color", Variants.class);

	public BlockStoneSlab_b(Material materialIn, SoundType sound, String registryName) {
		super(materialIn);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(BlocksRegistry.stone_slab_b);
	}

	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
		return new ItemStack(BlocksRegistry.stone_slab_b, 1, ((Variants) state.getValue(VARIANT)).getMetadata());
	}
	...
	public static class Double extends BlockStoneSlab_b {
	...
	public static class Half extends BlockStoneSlab_b {
	...
	public enum Variants implements IStringSerializable {
		DIORITE(0, "diorite"), ANDESITE(1, "andesite"), GRANITE(2, "granite"), CLAY(3, "clay"), BLUE_SLATE(4, "blue_slate"), CLAY_SLATE(5, "clay_slate");
