...
public abstract class BlockConcreteSlab extends BlockSlab implements MultipleItemObject, SpecialItemBlock {

    private static final PropertyEnum<Variants> VARIANT = PropertyEnum.create("color", Variants.class);

    public BlockConcreteSlab(Material materialIn, String registryName) {
        super(materialIn);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(BlocksRegistry.wool_slab);
    }

    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
        return new ItemStack(BlocksRegistry.wool_slab, 1, ((Variants) state.getValue(VARIANT)).getMetadata());
    }
    ...
    public static class Double extends BlockConcreteSlab {
    ...
    public static class Half extends BlockConcreteSlab {
