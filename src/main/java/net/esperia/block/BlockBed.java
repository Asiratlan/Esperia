...
public class BlockBed extends BlockHorizontal implements ITileEntityProvider
{
    ...
    public BlockBed(String registryName)
    {
        super(Material.WOOD);
    ...
    {
        return state.getValue(PART) == BlockBed.EnumPartType.FOOT ? Items.AIR : this.getItem();
    }
    ...
    public void dropBlockAsItemWithChance(World worldIn, BlockPos pos, IBlockState state, float chance, int fortune)
    {
        if (state.getValue(PART) == BlockBed.EnumPartType.HEAD)
        {
            spawnAsEntity(worldIn, pos, new ItemStack(this.getItem(), 1, 0));
        }
    }
    ...
    public ItemBed getItem() {
		String name = getRegistryName().getResourcePath();
		if (Item.getByNameOrId("esperia:" + name) == null)
			return new ItemBed(name, this);
		else
			return (ItemBed) Item.getByNameOrId("esperia:" + name);
    }
    ...
    {
        if (state.getValue(PART) == BlockBed.EnumPartType.HEAD && te instanceof TileEntityCustomBed)
        {
            TileEntityCustomBed TileEntityCustomBed = (TileEntityCustomBed)te;
            ItemStack itemstack = TileEntityCustomBed.getItemStack();
    ...
    {
        return new TileEntityCustomBed();
    }
