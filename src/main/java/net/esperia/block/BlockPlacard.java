...
public class BlockPlacard extends BlockContainer {

	public static final PropertyDirection FACING = BlockHorizontal.FACING;

	public BlockPlacard(String registryName) {
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
		...
		if (tile instanceof TileEntityPlacard) {
			TileEntityPlacard tileentitybiblio = (TileEntityPlacard) tile;

			if (tileentitybiblio != null) {
				playerIn.openGui(Esperia.instance(), 5, worldIn, pos.getX(), pos.getY(), pos.getZ());
			}
		}
	...
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
		return new ItemStack(net.esperia.BlocksRegistry.cupboard);
	}
