...
public abstract class BlockConcreteSlab_b extends BlockSlab implements MultipleItemObject, SpecialItemBlock {

    private static final PropertyEnum<Variants> VARIANT = PropertyEnum.create("color", Variants.class);

    public BlockConcreteSlab_b(Material materialIn, String registryName) {
        super(materialIn);
    ...
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
        return new ItemStack(this, 1, ((Variants) state.getValue(VARIANT)).getMetadata());
    }
    ...
    public static class Double extends BlockConcreteSlab_b {
    ...
    public static class Half extends BlockConcreteSlab_b {
