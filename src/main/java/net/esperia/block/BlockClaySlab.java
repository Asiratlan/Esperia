...
public abstract class BlockClaySlab extends BlockSlab implements MultipleItemObject, SpecialItemBlock {

	private static final PropertyEnum<Variants> VARIANT = PropertyEnum.create("color", Variants.class);

	public BlockClaySlab(Material materialIn, String registryName) {
		super(materialIn);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(BlocksRegistry.hardened_clay_slab);
	}

	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
		return new ItemStack(BlocksRegistry.hardened_clay_slab, 1, ((Variants) state.getValue(VARIANT)).getMetadata());
	}
	...
	public static class Double extends BlockClaySlab {
	...
	public static class Half extends BlockClaySlab {
	...
	public enum Variants implements IStringSerializable {
		WHITE(0, "white"), ORANGE(1, "orange"), MAGENTA(2, "magenta"), LIGHT_BLUE(3, "light_blue"), YELLOW(4,
				"yellow"), LIME(5, "lime"), PINK(6, "pink"), GRAY(7, "gray");
