...
public abstract class BlockWoolSlab_b extends BlockSlab implements MultipleItemObject, SpecialItemBlock {

    private static final PropertyEnum<Variants> VARIANT = PropertyEnum.create("color", Variants.class);

    public BlockWoolSlab_b(Material materialIn, String registryName) {
        super(materialIn);
    ...
    public static class Double extends BlockWoolSlab_b {
    ...
    public static class Half extends BlockWoolSlab_b {
