 ...
 * @author Tiago
 */
public class BlockSlowHalf extends Block {

    protected static final AxisAlignedBB SOUL_SAND_AABB = new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 0.5D, 1.0D);
    protected String name;

    public BlockSlowHalf(Material materialIn, String name) {
