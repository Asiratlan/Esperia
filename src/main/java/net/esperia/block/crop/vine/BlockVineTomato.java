 ...
 * @author Tiago
 */
public class BlockVineTomato extends BlockCrops {

    public BlockVineTomato() {
        setUnlocalizedName("tomato_vines");
        setRegistryName("tomato_vines");
