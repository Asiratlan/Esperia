...
public abstract class BlockHaySlab extends BlockSlab implements MultipleItemObject, SpecialItemBlock {

    private static final PropertyEnum<Variants> VARIANT = PropertyEnum.create("color", Variants.class);

    public BlockHaySlab(Material materialIn, SoundType sound, String registryName) {
        super(materialIn);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(BlocksRegistry.hay_slab);
    }

    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
        return new ItemStack(BlocksRegistry.hay_slab, 1, ((Variants) state.getValue(VARIANT)).getMetadata());
    }
    ...
    public static class Double extends BlockHaySlab {
    ...
    public static class Half extends BlockHaySlab {
